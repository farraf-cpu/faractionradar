# Core Retail Sales Predictor — Model Card

**Model version:** `v1-simple-blend`
**Event:** US Core Retail Sales m/m (monthly, ~mid-month, 08:30 ET, BLS; same release as headline CPI)
**Status:** Live — cadence T-7, T-4, T-3, T-2, T-1 via `predict-coreretail.yml`

## What v1-simple-blend does

Inverse-MAE-weighted blend. Cron 17:30 UTC daily.

| Sub-model | Source | Historical MAE (pp) |
|-----------|--------|---------------------|
| Bloomberg / FF consensus | live from calendar-worker `?read` | ~0.08 |
| FRED RSFSXMV 6-mo mean m/m | Core Retail Sales ex food + energy | ~0.15 |
