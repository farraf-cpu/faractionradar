# NB Policy Rate prediction - target 2026-09-17 (T-7)

**Model version:** `v2-outcome-distribution`
**Published:** 2026-09-10T18:43:51.164215+00:00

## Final pick

**1.72%** NB Policy Rate

- 68% CI: [1.57%, 1.87%] · sigma source: prior (inverse-MAE)
- 95% CI: [1.42%, 2.02%]
...
- **v2-outcome-distribution (2026-09-10)** - first ship. Phase 23 DKK expansion opens.
