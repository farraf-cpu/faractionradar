# Import Prices prediction — target 2026-09-16 (T-1)

**Model version:** `v1-simple-blend`
**Published:** 2026-09-15T17:23:40.363524+00:00

## Final pick

**+0.4%** m/m Import Price Index

- Regime: modest import inflation
- 68% CI: [+0.19%, +0.57%] · sigma source: prior (inverse-MAE)
- 95% CI: [+0.00%, +0.76%]
