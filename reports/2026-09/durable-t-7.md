# Durable Goods Orders prediction — target 2026-09-25 (T-7)

**Model version:** `v1.1-simple-blend`
**Published:** 2026-09-18T15:03:36.535433+00:00

## Final pick

**+0.3% m/m** (Durable Goods Orders, headline)

- 68% CI: [-0.15%, +0.82%] · sigma source: prior (inverse-MAE)
- 95% CI: [-0.63%, +1.30%]
- Lean vs consensus: no consensus
- Sub-models used: trend, core_orders
