# CA CPI prediction - target 2026-09-16 (T-1)

**Model version:** `v1.1-statcan`
**Published:** 2026-09-15T22:11:21.208414+00:00
...
- 68% CI: [+2.43%, +2.83%] · sigma source: prior (inverse-MAE)
- 95% CI: [+2.23%, +3.03%]
...
- **v1.1-statcan (2026-09-15)** - swapped stale FRED trend for live StatCan WDS API. Auto-active.
